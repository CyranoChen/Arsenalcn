...
namespace Arsenalcn.CasinoSys.DataAccess
{
    public class ChoiceOption
    {
        public static DataTable GetChoiceOptions(Guid itemGuid)
        {
            ...
            var ds = SqlHelper.ExecuteDataset(SQLConn.GetConnection(), CommandType.Text, sql, new SqlParameter("@guid", itemGuid));
        ...
        {
            var sql = "DELETE FROM AcnCasino_ChoiceOption WHERE (CasinoItemGuid NOT IN (SELECT CasinoItemGuid FROM AcnCasino_CasinoItem))";
        ...
        public static float GetOptionTotalBet(Guid itemGuid, string optionValue)
        {
            ...
            var obj = SqlHelper.ExecuteScalar(SQLConn.GetConnection(), CommandType.Text, sql, new SqlParameter("@guid", itemGuid), new SqlParameter("@optionValue", optionValue));
