    ...
    <div id="MainPanel">
        ...
        <asp:PlaceHolder ID="phBet" runat="server">
                    ...
                    <tr class="Row">
                        ...
                        <td align="left">
                            ...
                            <asp:LinkButton ID="btnSingleChoice" runat="server" Text="投注" CssClass="LinkBtn CashBtn"
                                            OnClick="btnSingleChoice_Click" OnClientClick="return BetConfirm();">
                            </asp:LinkButton>
                        </td>
                    </tr>
                    <tr class="Row" runat="server" id="trMatchResult">
                        ...
                        <td align="left">
                            <asp:TextBox ID="tbHome" runat="server" Text="主队" CssClass="TextBox HomeRes" Width="30"></asp:TextBox><em>vs</em><asp:TextBox
                                                                                                                                                 ID="tbAway" runat="server" Text="客队" CssClass="TextBox AwayRes" Width="30">
                            </asp:TextBox>
                            <asp:LinkButton ID="btnMatchResult" runat="server" Text="投注" CssClass="LinkBtn CashBtn"
                                            OnClick="btnMatchResult_Click" OnClientClick="return BetMatchResultConfirm();">
                            </asp:LinkButton>
                        </td>
                    </tr>
                    </tbody>
            ...
            <script type="text/javascript">
                ...
                $("input.BetCount").focus(function() {
                    if ($(this).val() == oriStr) {
                        $(this).val("");
                    }
                });
                $("input.BetCount").blur(function() {
                    if ($(this).val() == "") {
                        $(this).val(oriStr);
                    }
                });
                ...
                $("input.HomeRes").focus(function() {
                    if ($(this).val() == home) {
                        $(this).val("");
                    }
                });
                $("input.HomeRes").blur(function() {
                    if ($(this).val() == "") {
                        $(this).val(home);
                    }
                });
                ...
                $("input.AwayRes").focus(function() {
                    if ($(this).val() == away) {
                        $(this).val("");
                    }
                });
                $("input.AwayRes").blur(function() {
                    if ($(this).val() == "") {
                        $(this).val(away);
                    }
                });
        ...
        <asp:GridView ID="gvBet" runat="server" OnRowDataBound="gvBet_RowDataBound">
            <Columns>
                ...
                <asp:TemplateField HeaderText="收益预测">
                    <ItemTemplate>
                        <em>
                            <asp:Literal ID="ltrlBonusCalc" runat="server"></asp:Literal>
                        </em>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
