                ...
                <asp:TemplateField HeaderText="当月RP王">
                    <ItemTemplate>
                        <a href="MyBonusLog.aspx?UserID=<%#DataBinder.Eval(Container.DataItem, "RPUserID") %>"
                           target="_blank" class="StrongLink">
                            <%#DataBinder.Eval(Container.DataItem, "RPUserName") %>
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
