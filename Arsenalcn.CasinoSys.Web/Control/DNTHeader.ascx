...
<div id="menubar">
    <ul id="menu" class="cl">
        ...
        <li><a href="/plugin/acncasino/" class="current">博彩</a></li>
...
<div id="nav">
    ...
    <div id="stats">
        玩家:<em><asp:Literal ID="ltrlGamblerCount" runat="server"></asp:Literal></em>, 比赛:<em><asp:Literal
            ID="ltrlGameCount" runat="server"></asp:Literal></em>, ACN庄家(博彩币):<em><asp:Literal
                ID="ltrlDefaultBanker" runat="server"></asp:Literal></em>
    </div>
    <div class="Clear">
    </div>
</div>
