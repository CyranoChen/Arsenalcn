...
<%@ Register Src="TopMatchList.ascx" TagName="TopMatchList" TagPrefix="uc1" %>
...
<div id="LeftPanel">
    <asp:Panel ID="pnlNotice" runat="server" CssClass="InfoPanel">
        ...
        <div class="Block">
            <p class="CasinoSys_Notice">
                <%=Arsenalcn.CasinoSys.Entity.ConfigGlobal.SysNotice %></p>
        </div>
    </asp:Panel>
    <asp:Panel ID="pnlMyCasino" runat="server" CssClass="InfoPanel">
        ...
        <div class="Block">
            <ul>
                <li class="LiTitle">博彩币:<em style="font-size: 12px; margin: 0px 2px"><asp:Literal
                    ID="ltrlCash" runat="server"></asp:Literal>
    ...
    <uc2:TopGamblerList ID="TopGamblerList1" runat="server" />
    <uc1:TopMatchList ID="TopMatchList1" runat="server" />
