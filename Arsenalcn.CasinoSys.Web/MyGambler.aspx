                    ...
                    <tr class="CasinoSys_Tip">
                        <td colspan="2">
                            <span>您现有枪手币<em><asp:Literal ID="ltrlUserQSB" runat="server"></asp:Literal></em> | 博彩币<em><asp:Literal
                                ID="ltrlUserCash" runat="server"></asp:Literal></em> | 转换比率为<em>1:<%=Arsenalcn.CasinoSys.Entity.ConfigGlobal.ExchangeRate %></em>
                                | 提现手续费<em><%=Arsenalcn.CasinoSys.Entity.ConfigGlobal.ExchangeFee.ToString("p0")%></em></span>
                        </td>
                    </tr>
                    <tr class="Row">
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfvToCash" runat="server" ControlToValidate="tbCash"
                                Display="Dynamic" ErrorMessage="*输入不能为空" ValidationGroup="ToCash"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr class="Row">
                        <td class="FieldHeader">
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfvToQSB" runat="server" ControlToValidate="tbQSB"
                                Display="Dynamic" ErrorMessage="*输入不能为空" ValidationGroup="ToQSB"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
