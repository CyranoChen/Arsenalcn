            ...
            <div class="BaseInfoPanel">
                <dl>
                    <dt>
                        <label>
                            简称:
                        </label><asp:Literal ID="ltrlShortName" runat="server"></asp:Literal>
                    </dt>
                    <dd>
                        <label>
                            创建人:
                        </label><asp:Literal ID="ltrlCreatorName" runat="server"></asp:Literal>
                    </dd>
                    <dt>
                        <label>
                            球会口号:
                        </label><asp:Literal ID="ltrlSlogan" runat="server"></asp:Literal>
                    </dt>
                </dl>
                <dl>
                    <dd title="全部会员数">
                        <label>
                            ...
                            <asp:Literal ID="ltrlMemeberCount" runat="server"></asp:Literal>/<asp:Literal
                                                                                                 ID="ltrlMemberQuota" runat="server">
                            </asp:Literal>
                        </em>(<asp:Literal ID="ltrlAppliable"
                                           runat="server">
                        </asp:Literal>)
                    </dd>
                    <dd title="球会积累的财富值">
                        <label>
                            ...
                            <asp:Literal ID="ltrlFortune" runat="server"></asp:Literal>
                        </em>枪手币
                    </dd>
                    <dd title="全部会员的积分总和">
                        <label>
                    ...
                    <dd title="全部会员的金钱总和">
                        <label>
                            ...
                            <asp:Literal ID="ltrlMemberFortune" runat="server"></asp:Literal>
                        </em>枪手币
                    </dd>
                    ...
                    <asp:Repeater ID="rptClubLeads" runat="server">
                        <ItemTemplate>
                            <li<%# DataBinder.Eval(Container.DataItem, "AdditionalData2") %>>
                                <%# DataBinder.Eval(Container.DataItem, "AdditionalData") %>: <a href="MyPlayerProfile.aspx?userid=<%#DataBinder.Eval(Container.DataItem, "Userid") %>" target="_blank"><%#DataBinder.Eval(Container.DataItem, "UserName") %></a>
                            </li>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
                <div class="CreateDate">
                    创建于<asp:Literal ID="ltrlCreateDate" runat="server"></asp:Literal>,有<em>
                        <asp:Literal
                            ID="ltrlDays" runat="server">
                        </asp:Literal>
                    </em>天历史
                </div>
            </div>
