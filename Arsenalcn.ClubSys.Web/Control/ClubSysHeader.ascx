        ...
        <tr>
            ...
            <td class="ClubBtnGroup">
                ...
                <asp:LinkButton ID="btnJoinClub" runat="server" CssClass="LinkBtn JoinBtn" Text="加入球会(审核)"
                                OnClick="btnJoinClub_Click" OnClientClick="return window.confirm('您是否要加入该球会？');">
                </asp:LinkButton>
                <asp:LinkButton ID="btnCancelApply" runat="server" CssClass="LinkBtn CancelBtn" Text="取消申请"
                                OnClick="btnCancelApply_Click" OnClientClick="return window.confirm('您是否要取消加入球会申请？');">
                </asp:LinkButton>
                <asp:LinkButton ID="btnLeaveClub" runat="server" CssClass="LinkBtn BackBtn" Text="退出球会"
                                OnClick="btnLeaveClub_Click" OnClientClick="return window.confirm('您是否要退出该球会？');">
                </asp:LinkButton>
                <!-- 会长/干事专用显示 -->
