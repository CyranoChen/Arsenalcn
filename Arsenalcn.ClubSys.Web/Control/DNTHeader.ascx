...
<div id="menubar">
    <ul id="menu" class="cl">
        <li>
            <a href="/plugin/acnclub/" class="current">球会</a>
        </li>
        <li>
            <a href="/plugin/acncasino/">博彩</a>
        </li>
        <li>
...
<div id="nav">
    ...
    <div id="stats">
        球会:<em>
            <asp:Literal ID="ltrlClubCount" runat="server"></asp:Literal>
        </em>, 会员:<em>
            <asp:Literal
                ID="ltrlUserCount" runat="server">
            </asp:Literal>
        </em>, 球员:<em>
