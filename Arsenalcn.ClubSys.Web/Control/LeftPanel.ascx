    ...
    <asp:Panel ID="pnlClubNotice" runat="server" CssClass="InfoPanel">
        ...
        <div class="Block">
            <p class="ClubSys_Notice">
                <%=Arsenalcn.ClubSys.Entity.ConfigGlobal.SysNotice%></p>
        </div>
    </asp:Panel>
        ...
        <div class="Block">
            <ul>
                ...
                <asp:PlaceHolder ID="phCreateClub" runat="server">
                    <li><a href="MyCreateClub.aspx">创建我的新球会</a></li>
                </asp:PlaceHolder>
                <li><a href="MyHistoryLog.aspx">我的球会历史</a></li>
                <li><a href="MyPlayerProfile.aspx">我的球员信息</a></li>
                <li><a href="MyCollection.aspx">我的球员收藏</a></li>
                <asp:PlaceHolder ID="phClubAdmin" runat="server">
                    <li>
                        <asp:HyperLink ID="hlMyAdminClub" runat="server" Text="管理我的球会" /></li>
                </asp:PlaceHolder>
            </ul>
        </div>
    </asp:Panel>
