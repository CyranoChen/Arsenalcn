...
<div class="ClubSys_Header">
    ...
    <div class="PlayerItemList">
        <ul>
            <li>
                <span class="ClubSys_Strip Shirt">球衣:</span><em>LV<%= shirtLv %></em>
            </li>
            <li>
                <span class="ClubSys_Strip Shorts">球裤:</span><em>LV<%= shortsLv %></em>
            </li>
            <li>
                <span class="ClubSys_Strip Sock">球袜:</span><em>LV<%= sockLv %></em>
            </li>
        </ul>
    </div>
    <div class="PlayerItemList">
        <ul>
            <li>
                尝试:<em title="今天(累计)">
                    <%= PlayerStrip.GetUserBingoPlayCountToday(ProfileUserID).ToString() %>
                    (<%= PlayerStrip.GetUserBingoPlayCount(ProfileUserID).ToString() %>)
                </em>
            </li>
            <li>
                获得:<em title="今天(累计)">
                    <%= PlayerStrip.GetUserBingoGainCountToday(ProfileUserID).ToString() %>
                    (<%= PlayerStrip.GetUserBingoGainCount(ProfileUserID).ToString() %>)
                </em>
            </li>
            <li>RP:<em title="抽中率">
