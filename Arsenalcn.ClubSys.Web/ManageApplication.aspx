...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div id="MainPanel">
        ...
        <asp:Panel ID="pnlInaccessible" runat="server" CssClass="ClubSys_Tip" Visible="false">
            <label>
                您不是该球会会长或干事，不得进入此页面。</label></asp:Panel>
        ...
        <asp:GridView ID="gvClubMemberList" runat="server" AllowPaging="true" PageSize="5"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="积分">
                    <ItemTemplate>
                        <em>
                            <asp:Literal ID="ltrlUserCredit" runat="server"></asp:Literal></em>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="金钱">
                    <ItemTemplate>
                        <em>
                            <asp:Literal ID="ltrlUserFortune" runat="server"></asp:Literal></em>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="发帖数">
                    <ItemTemplate>
                        <em>
                            <asp:Literal ID="ltrlUserPosts" runat="server"></asp:Literal></em>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="审核">
                    <ItemTemplate>
                        <a class="LinkBtn JoinBtn" href="javascript:ActionClicked(<%#DataBinder.Eval(Container.DataItem, "ID") %>, true);">
                            通过</a> <a class="LinkBtn BackBtn" href="javascript:ActionClicked(<%#DataBinder.Eval(Container.DataItem, "ID") %>, false);">
                                驳回</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
