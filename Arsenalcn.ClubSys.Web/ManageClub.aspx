...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div id="MainPanel">
        ...
        <asp:Panel ID="pnlInaccessible" runat="server" CssClass="ClubSys_Tip" Visible="false">
            <label>
                您不是该球会会长，不得进入此页面。</label></asp:Panel>
            ...
            <table class="DataView" cellspacing="0" cellpadding="5">
                <tbody>
                    <tr class="ClubSys_Tip">
                        <td colspan="2">
                            <label>
                                欢迎<em><asp:Literal ID="ltrlClubName" runat="server"></asp:Literal></em>的会长<em><asp:Literal
                                    ID="ltrlClubManagerName" runat="server"></asp:Literal></em>进入球会管理(会长专用)。</label>
                        </td>
                    </tr>
                    <tr class="Row">
