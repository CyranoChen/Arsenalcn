...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div id="MainPanel">
        ...
        <asp:Panel ID="pnlInaccessible" runat="server" CssClass="ClubSys_Tip" Visible="false">
            <label>
                您已加入了球会，或者拥有了球会，或者发帖数没有达到<asp:Literal ID="ltrlMinPosts1" runat="server"></asp:Literal>，不可申请新球会。
            </label>
        </asp:Panel>
        <asp:PlaceHolder ID="phContent" runat="server">
            <table class="DataView" cellspacing="0" cellpadding="5">
                ...
                <tr class="ClubSys_Tip">
                    <td colspan="2">
                        <label>
                            您的发帖数&gt;<asp:Literal ID="ltrlMinPosts" runat="server"></asp:Literal>，可以申请新家族，申请提交后，请耐心等待管理员审核。
                        </label>
                    </td>
                </tr>
