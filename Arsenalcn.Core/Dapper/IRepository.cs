...
namespace Arsenalcn.Core
{
    public interface IRepository
    {
        ...
        int Count<T>(Expression<Func<T, bool>> whereBy) where T : class, IDao, new();

        bool Any<T>(object key) where T : class, IEntity;
        bool Any<T>(Expression<Func<T, bool>> whereBy) where T : class, IDao, new();
        ...
        List<T> Query<T>(IPager pager, Expression<Func<T, bool>> whereBy, string orderBy = null)
