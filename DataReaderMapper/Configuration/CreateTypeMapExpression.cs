...
namespace DataReaderMapper.Configuration
{
    public class CreateTypeMapExpression : IMappingExpression
    {
        ...
        public IMappingExpression ForSourceMember(string sourceMemberName,
        ...
        public IMappingExpression ForCtorParam(string ctorParamName,
