...
namespace DataReaderMapper
{
    public interface IConfigurationProvider : IConfiguration
    {
        ...
        /// <summary>
        ///     Find the <see cref="TypeMap" /> for the configured source and destination type, checking the source/destination
        ///     object types too
        /// </summary>
        ...
        TypeMap CreateTypeMap(Type sourceType, Type destinationType,
            string profileName = ConfigurationStore.DefaultProfileName);
