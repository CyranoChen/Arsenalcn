...
namespace DataReaderMapper
{
    ...
    public interface IMappingExpression
    {
        ...
        IMappingExpression ForCtorParam(string ctorParamName,
            Action<ICtorParamConfigurationExpression<object>> paramOptions);
        ...
        /// <summary>
        ///     Replace the original runtime instance with a new source instance. Useful when ORMs return proxy types with no
        ///     relationships to runtime types.
        ...
        /// <summary>
        ///     Skip normal member mapping and convert using a <see cref="ITypeConverter{TSource,TDestination}" /> instantiated
        ///     during mapping
        /// </summary>
        ...
        /// <summary>
        ///     Ignores all destination properties that have either a private or protected setter, forcing the mapper to respect
        ///     encapsulation (note: order matters, so place this before explicit configuration of any properties with an
        ///     inaccessible setter)
        /// </summary>
        /// <returns>Itself</returns>
        ...
        /// <summary>
        ///     When using ReverseMap, ignores all source properties that have either a private or protected setter, keeping the
        ///     reverse mapping consistent with the forward mapping (note: destination properties with an inaccessible setter may
        ///     still be mapped unless IgnoreAllPropertiesWithAnInaccessibleSetter is also used)
        /// </summary>
        /// <returns>Itself</returns>
    ...
    public interface IMappingExpression<TSource, TDestination>
    {
        ...
        ///     <typeparamref name="TDestination" />TDestination
        /// </param>
        /// type
        /// <param name="memberOptions">Callback for member options</param>
        /// <returns>Itself</returns>
        ...
        /// <summary>
        ///     Ignores all <typeparamref name="TDestination" /> properties that have either a private or protected setter, forcing
        ///     the mapper to respect encapsulation (note: order matters, so place this before explicit configuration of any
        ///     properties with an inaccessible setter)
        /// </summary>
        /// <returns>Itself</returns>
        IMappingExpression<TSource, TDestination> IgnoreAllPropertiesWithAnInaccessibleSetter();

        /// <summary>
        ///     When using ReverseMap, ignores all <typeparamref name="TSource" /> properties that have either a private or
        ///     protected setter, keeping the reverse mapping consistent with the forward mapping (note:
        ///     <typeparamref name="TDestination" /> properties with an inaccessible setter may still be mapped unless
        ///     IgnoreAllPropertiesWithAnInaccessibleSetter is also used)
        /// </summary>
        /// <returns>Itself</returns>
        ...
        /// <summary>
        ///     Create a type mapping from the destination to the source type, using the <typeparamref name="TDestination" />
        ///     members as validation
        /// </summary>
        /// <returns>Itself</returns>
        ...
        ///     Expression to source member. Must be a member of the <typeparamref name="TSource" />
        ///     type
        /// </param>
        /// <param name="memberOptions">Callback for member configuration options</param>
        /// <returns>Itself</returns>
