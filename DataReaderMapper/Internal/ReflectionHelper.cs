...
namespace DataReaderMapper.Internal
{
    public static class ReflectionHelper
    {
        ...
        {
            return new ArgumentOutOfRangeException("propertyOrField",
        ...
        public static MemberInfo GetFieldOrProperty(Type type, string memberName)
        {
            return memberName.Split('.')
                .Aggregate((MemberInfo) null,
                    (property, member) => (property?.GetMemberType() ?? type).GetMember(member).Single());
        }
        ...
        public static MemberInfo GetFieldOrProperty(this LambdaExpression expression)
        {
            ...
            if (memberExpression == null)
            {
                throw new ArgumentOutOfRangeException("expression",
                    "Expected a property/field access expression, not " + expression);
            }
