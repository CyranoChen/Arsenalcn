    ...
    public class ConditionalObjectMapper : IConditionalObjectMapper
    {
        ...
        public object Map(ResolutionContext context, IMappingEngineRunner mapper)
        {
            ...
            Func<TypePair, IObjectMapper> missFunc =
                tp => context.Engine.ConfigurationProvider.GetMappers().FirstOrDefault(m => m.IsMatch(context));
        ...
        public ICollection<Func<ResolutionContext, bool>> Conventions { get; } =
            new Collection<Func<ResolutionContext, bool>>();
    }

    public static class ConventionGeneratorExtensions
    {
        public static IConditionalObjectMapper Where(this IConditionalObjectMapper self,
            Func<Type, Type, bool> condition)
        {
