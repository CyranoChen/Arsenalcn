...
namespace DataReaderMapper.QueryableExtensions.Impl
{
    public static class QueryMapperHelper
    {
        ...
        {
            var typeMap = mappingEngine.ConfigurationProvider.FindTypeMapFor(sourceMemberInfo.DeclaringType,
            ...
            if (typeMap == null)
            {
                ...
                var message = string.Format(MessageFormat, sourceMemberInfo.DeclaringType.Name,
