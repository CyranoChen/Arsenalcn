...
<asp:Content ID="cphHead" ContentPlaceHolderID="cphhead" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.each($(".Deadline .TextBox"), function (i, entry) {
                $(entry).datepicker({ defaultDate: $(this).val() });
            });
        });
    </script>
</asp:Content>
            ...
            <table class="DataView">
                ...
                <tbody>
                    ...
                    <tr class="AlternatingRow">
                        ...
                        <td class="FieldColumn Deadline">
                            <asp:TextBox ID="tbDeadline" runat="server" CssClass="TextBox" Width="180px"></asp:TextBox>
                        </td>
                        <td class="FieldHeader">补票截止:
                        </td>
                        <td class="FieldColumn Deadline">
                            <asp:TextBox ID="tbWaitingDeadline" runat="server" CssClass="TextBox" Width="180px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr class="AlternatingRow">
