...
<asp:Content ID="cphMain" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div id="MainPanel">
        ...
        <div class="Arsenal_MainInfo">
            ...
            <asp:GridView ID="gvMatchOrder" runat="server" DataKeyNames="OrderID" OnSelectedIndexChanged="gvMatchOrder_SelectedIndexChanged"
                OnRowDataBound="gvMatchOrder_RowDataBound">
                <Columns>
