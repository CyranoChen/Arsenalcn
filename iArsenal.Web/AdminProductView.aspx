            ...
            <table class="DataView">
                ...
                <tbody>
                    ...
                    <tr class="Row">
                        ...
                        <td class="FieldColumn">
                            <asp:TextBox ID="tbImageUrl" runat="server" CssClass="TextBox" Width="250px" Text="UploadFiles/Product/"></asp:TextBox>
                        </td>
                        <td class="FieldHeader">二维码:
                        </td>
                        <td class="FieldColumn">
                            <asp:TextBox ID="tbQrCodeUrl" runat="server" CssClass="TextBox" Width="250px" Text=""></asp:TextBox>
                        </td>
                    </tr>
                    <tr class="AlternatingRow">
