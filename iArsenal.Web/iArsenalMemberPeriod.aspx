    ...
    <div id="ACN_Main">
        ...
        <div id="rightPanel">
            ...
            <div class="InfoPanel">
                ...
                <div class="Block">
                    <p>(1). Arsenalcn Core会员作为普通收费会员，在实名登记真实信息后，可预订阿森纳主场<em>非</em>（A级或特定比赛）的其他比赛球票。
                    </p>
                    <p>(2). Arsenalcn Premier会员作为高级收费会员，在实名登记真实信息后，可预订<em>阿森纳主场所有比赛球票</em>。
                    </p>
                    <p>(3). Core会员在赛季中补足差额，可升级为Premier会员，以预定A级或特定比赛球票。</p>
                    <p>(4). 上个赛季已经成为Premier的高级会员，如在本赛季续费<em>88折</em>优惠，即以<em>422元</em>续约一个赛季会员资格。
                    </p>
                    <p>
                        (5). 球迷会客服联系方式：<br/>
