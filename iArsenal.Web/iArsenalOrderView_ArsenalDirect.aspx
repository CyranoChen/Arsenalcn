...
<asp:Content ID="cphHead" ContentPlaceHolderID="cphHead" runat="server">
    <style type="text/css">
        .OrderPrice, .OrderProductGuid { display: none; }
    </style>
        ...
        <div id="rightPanel">
            <div class="InfoPanel">
                ...
                <div class="Block">
                    ...
                    <p>(3).【确认】查看后台反馈的已审核订单，确认无误后，点击<em>【确认按钮】</em>完成预订。
                    </p>
            ...
            <div class="InfoPanel">
                ...
                <div class="Block">
                    ...
                    <p>(2).【小店】淘宝会员专享店地址： <a href="http://arsenalcn.taobao.com/" target="_blank">
                            <em>http://arsenalcn.taobao.com</em>
                        </a>
                    </p>
                    <p>(3).【认领】按自己预订的商品进淘宝小店认领并交易。店中名称前带有<em>【*】</em>货品的为会员预定品，其他非预定者的商品如有看中，可以随意购买。
                    </p>
                </div>
            </div>
        </div>
