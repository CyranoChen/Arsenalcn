        ...
        <div id="rightPanel">
            <div class="InfoPanel">
                ...
                <div class="Block">
                    ...
                    <p>
                        (3).【确认】查看后台反馈的已审核订单，确认无误后，点击<em>【确认按钮】</em>完成预订。
                    </p>
            ...
            <div class="InfoPanel">
                ...
                <div class="Block">
                    <p>(1).【微信】到货后通过微信客服通知联系，您可选择在微信转账付款后，直接为您发货。</p>
                    <p>(2).【淘宝】到货后也可通过淘宝会员专享店完成交易操作(选拍商品→买家付款→卖家发货→确认收货)。</p>
                    <p>
                        (3). 淘宝会员专享店地址： <a href="http://arsenalcn.taobao.com/" target="_blank">
