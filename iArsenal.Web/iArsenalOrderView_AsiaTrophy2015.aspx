    ...
    <div id="ACN_Main">
        ...
        <div id="rightPanel">
            ...
            <div class="InfoPanel">
                ...
                <div class="Block">
                    <p>(1). 我们会通过微博、微信：<em>iArsenalcn</em>，进行联系通知，请有意者关注或加入时，注明新加坡观赛与真实姓名即可。
                    </p>
                    <p>(2). 请各位确定关注并仔细阅读组织者发出的<em>确认邮件</em>，其中包含行程安排与参与活动项目的信息。
                    </p>
                    <p>(3). 左侧计算出了各位的球票、训练课门票定金费用，分项价格已通过确认函的邮件发给各位。<em>请根据上方的付款方式转帐付款即可。</em>
                    </p>
                    <p>(4). 我们会在<em>7月1日</em>前将球票发送给各位付款会员，并各位将获得优先分配训练课门票的机会。如训练课不对外公开，我们将全额退还训练课部分的定金。
                    </p>
