    ...
    <div id="ACN_Main">
            ...
            <table class="DataView">
                ...
                <tbody>
                    ...
                    <tr class="Row">
                        ...
                        <td style="text-align: left">
                            <asp:Label ID="lblOrderItem_Quantity" runat="server"></asp:Label>
                        </td>
        ...
        <div id="rightPanel">
            ...
            <div class="InfoPanel">
                ...
                <div class="Block">
                    <p>
                        (1). 由于一般订票时间与比赛时间的间隔时间较长，我们建议会员对于A/B/C级比赛球票用淘宝交易方式，可通过访问<a href="http://arsenalcn.taobao.com" target="_blank"><em>球迷会淘宝商城</em></a>，拍下相应级别的球票。
                    </p>
                    <p>
                        (2). 特价球票建议用支付宝或银行转帐交易，如没有淘宝帐号，一般比赛球票亦可用上述方式交易。请订票者根据实际情况进行选择。
                    </p>
                    <p>
                        (3). 球票一般采用<em>人民币</em>进行交易，如需通过<em>英磅</em>交易或有其他需求，请与负责人联系。
                    </p>
                    <p>
                        (4). 订票者可比赛订票的截止时间之前，申请退票；截止时间之后，原则上不可退票，如有特殊需求，请与负责人联系。
                    </p>
                    <p>
                        (5). 票务负责人联系方式：<br />
