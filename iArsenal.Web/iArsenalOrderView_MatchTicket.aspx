    ...
    <div id="ACN_Main">
        ...
        <div id="rightPanel">
            ...
            <div class="InfoPanel">
                ...
                <div class="Block">
                    <p>
                        (1). 由于一般订票时间与比赛时间的间隔时间较长，我们建议会员彩用淘宝交易方式，可通过访问<a href="http://arsenalcn.taobao.com" target="_blank">
                            <em>球迷会淘宝商城</em></a>，拍下相应级别的球票，待出票后再确认收货。
                    </p>

                    <p>(2). 您亦可通过扫描上方<em>二维码</em>的微店链接，通过微信钱包快捷付款。此方式可使用信用卡支付，钱款将直接到账。</p>

                    <p>(3). 您亦可通过上方付款信息栏中的支付宝或银行转账。此方式钱款将直接到账。</p>
