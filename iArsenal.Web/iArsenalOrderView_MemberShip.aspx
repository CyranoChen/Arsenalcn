    ...
    <div id="ACN_Main">
        ...
        <div id="rightPanel">
            ...
            <div class="InfoPanel">
                ...
                <div class="Block">
                    <p>(1). 请会员提交本会籍申请订单后，尽快前往<a href="http://arsenalcn.taobao.com" target="_blank">
                            <em>球迷会淘宝商城</em>
                            ...
                            <em>高级(Premier)会员</em>
                        </a>的会员费，或通过其他两种方式付款。如代付其他会员的会员费，请在<em>付款备注</em>中注明代付会员的真实姓名。
                    </p>
                    <p>(2). 待管理员为您确认会籍信息后，会与您联系确认，即可预订或提交<a href="iArsenalOrder.aspx">
                            <em>主场球票订单</em>
                        </a>。
                    </p>
                    <p>(3). 如您已经是普通(Core)会员，需要订购A级或特定重要比赛球票，则需要升级成为高级(Premier)会员。您可在提交订单后，前往球迷会淘宝商城拍下<a href="http://item.taobao.com/item.htm?id=40251196901" target="_blank">
                            <em>升级会员费</em>
                        </a>即可。
                    </p>
                    <p>(4). 申请操作中如有问题，请咨询官方球迷会服务微信号：<em>iArsenalCN</em>。加入时验证方式为您注册本服务中心的真实姓名和手机号码，并注明<em>【球票】</em>字样。
                    </p>
                </div>
            </div>
        </div>
