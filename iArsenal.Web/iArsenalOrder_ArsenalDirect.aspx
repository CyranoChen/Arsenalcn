...
<asp:Content ID="cphMain" ContentPlaceHolderID="cphMain" runat="server">
    <div id="banner" style="height: 430px">
        <a href="http://bbs.arsenalcn.com/showtopic-108228.aspx" target="_blank">
            <img src="uploadfiles/banner/banner20151118.png" alt="阿森纳官方纪念品团购服务"/>
        </a>
    </div>
    <div id="ACN_Main">
        ...
        <div id="rightPanel">
            <div class="InfoPanel">
                ...
                <div class="Block">
                    ...
                    <p>(2). 约定汇率含全部国际运费和海关关税分摊；国内快递费自理（从中国上海发到国内各地的运费，只发<em>【顺丰速运】</em>）
                    </p>
                    <p>(2). Arsenal官方专卖店网址： <a href="http://arsenaldirect.arsenal.com/" target="_blank">
                            <em>http://arsenaldirect.arsenal.com</em>
                        </a>
                    </p>
                    <p>(3). 此功能入口负责除主客场球衣外，所有阿森纳纪念品的订购。若需订购各款球衣，请点击菜单中的<a href="iArsenalOrder_ReplicaKit.aspx" target="_blank">
                            <em>【主客场球衣预订服务】</em>
                        </a>。
                    </p>
