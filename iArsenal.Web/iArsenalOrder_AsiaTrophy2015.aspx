    ...
    <div id="ACN_Main">
                    ...
                    <tr class="Row">
                        ...
                        <td style="text-align: left;" colspan="3">
                            <asp:RadioButtonList ID="rblIsTicketOnly" runat="server" RepeatDirection="Horizontal"
                                RepeatLayout="Flow" CssClass="RadioButtonList">
                                <asp:ListItem Text="观赛团报名（已结束报名）" Value="Tour" Enabled="false"></asp:ListItem>
                                <asp:ListItem Text="仅预定比赛门票" Value="Ticket" Selected="True"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr class="AlternatingRow" style="display: none">
                        ...
                        <td style="text-align: left; line-height: 2;" colspan="3">
                            <asp:CheckBoxList ID="cblTravelOption" runat="server" RepeatDirection="Vertical" RepeatLayout="Flow">
                                <asp:ListItem Text="代为办理签证" Value="VISA"></asp:ListItem>
                                <asp:ListItem Text="统一购买机票前往新加坡" Value="FLIGHT"></asp:ListItem>
                                <asp:ListItem Text="统一预订宾馆并安排入住" Value="HOTEL"></asp:ListItem>
                                <asp:ListItem Text="参观赛前训练课" Value="TRAINING"></asp:ListItem>
                                <asp:ListItem Text="参加球员见面会（暂未确定）" Value="PARTY"></asp:ListItem>
                                <asp:ListItem Text="参加新加坡当地球迷会活动" Value="SINGAPORE"></asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr class="Row">
        ...
        <div id="rightPanel">
            <div class="InfoPanel">
                ...
                <div class="Block">
                    <p>
                        (1). 观赛团报名结束，现在仅提供<em>订票服务</em>。<em>订票截至时间：2015年7月5日</em>
                    </p>
                    <p>
                        (2). 请完整填写出行会员的个人信息，每位会员可登记一个同伴，同伴信息也请填写完整。我们会为会员的个人信息进行保密。
                    </p>
                    <p>
                        (3). 我们会在收到预订报名表后，核对身份信息，并与您取得联系，您可加入微信：<em>iArsenalcn</em>，关注最新信息发布。
                    </p>
                    <p>
                        (4). 如有问题，可与ACN负责人Cyrano联系。QQ：<em>22287842</em>，Email：<a href="mailto:cyrano@arsenalcn.com"><em>cyrano@arsenalcn.com</em>。</a>
                    </p>
                </div>
            </div>
            <div class="InfoPanel">
                ...
                <div class="Block">
                    ...
                    <p>(1). <em>7月14日 (周二)</em> 统一或各自出行航班前往新加坡，接机回酒店入住。（训练课可能安排在当天晚上）</p>
                    ...
                    <p>(5). <em>7月18日 (周六)</em> 比赛前国家体育场集合入场观战。新加坡官方球迷会聚会活动。</p>
