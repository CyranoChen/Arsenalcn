    ...
    <div id="ACN_Main">
        ...
        <div id="rightPanel">
            ...
            <div class="InfoPanel">
                ...
                <div class="Block">
                    <p>
                        1. 由于球迷会预订平价球票供不应求，从本赛季开始所有预订联赛、足总杯、欧冠比赛的主场球票，均需升级为<a href="iArsenalMemberPeriod.aspx" target="_blank">
                            <em>【收费会员】</em>
                        </a>。
                    </p>
                    <p>
                        2. 根据俱乐部要求，为防止黄牛倒票现象，每一个预订球票会员必须以实名身份登记备案，<em>【每一个会员资格只能买一张票】</em>。同行者也需登记备案，并升级为<a href="iArsenalMemberPeriod.aspx" target="_blank">
                            <em>【收费会员】</em>
                        </a>方能预订购买。
                    </p>
                    <p>
                        3. 所有球票仍按票面平价*汇率（比市场汇率略高，现为<em>11.5</em>）销售，此价格已包括送票费、汇率手续费等，统一采用人民币结算。结算确认成功后，原则上直至比赛日取票、看球，不再额外收取任何费用。
                    </p>
                </div>
            </div>
            <div class="InfoPanel">
                ...
                <div class="Block">
                    ...
                    <p>
                        (1).球票座位为著名的南看台（海布里大钟 Clock End）的上层前排球票，即电视直播镜头的<em>右侧球门后上层看台</em>。
                    </p>
                    ...
                    <p>
                        (4).收费会员可预订的所有场次球票，在截止时间之前预订成功，<em>确保有票</em>。
                    </p>
                </div>
            </div>
        </div>
